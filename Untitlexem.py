...
def ajout3():
    ...
    entryprecarburant=Entry(ajout)
    entryprecarburant.place(x=230,y=160)
    ...
    enregistrer=Button(ajout,text='Enregistrer',command=lambda:ajout3())
    enregistrer.place(x=330,y=330)
...
voiture_menu.add_command(label='Quitter',command=q.destroy)
